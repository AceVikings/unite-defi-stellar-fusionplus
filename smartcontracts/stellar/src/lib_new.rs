#![no_std]
use soroban_sdk::{contract, contractimpl, Address, Env, String, BytesN, Bytes, panic_with_error};
...
impl StellarHTLC {
    ...
    pub fn create_swap(
        ...
        // Get the sender (current transaction invoker)
