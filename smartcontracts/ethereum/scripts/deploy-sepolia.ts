...
async function main() {
  ...
  try {
    ...
    console.log("✅ HTLC contract is responsive. Current time:", currentTime.toString());
  ...
  console.log(`   npx hardhat verify --network sepolia ${tokenAddress} "Sepolia Test Token" "STEST" 18 "1000000000000000000000000"`);
